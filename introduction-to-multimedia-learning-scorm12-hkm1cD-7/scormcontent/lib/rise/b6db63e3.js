"use strict";(self.wpRiseJsonp=self.wpRiseJsonp||[]).push([["vendors-node_modules_pnpm_articulate_design-system_1_9_1__articulate_design-system-tokens_1_2-7bed71"],{5023:(nn,Ra,qr)=>{qr.r(Ra),qr.d(Ra,{Arc:()=>yi,ArcAbstractFlexLayouts:()=>qe,ArcAbstractGapSizes:()=>Ma,ArcAbstractIconSizes:()=>ha,ArcAbstractTextLayouts:()=>Xe,ArcAbstractTextOverflows:()=>Ba,ArcAbstractTextSizes:()=>Ye,ArcAvatar:()=>ka,ArcAvatarColors:()=>le,ArcAvatarColorsReserved:()=>vt,ArcAvatarOverflow:()=>mo,ArcAvatarOverflowSizes:()=>$t,ArcAvatarPile:()=>It,ArcAvatarPileSizes:()=>xt,ArcAvatarSizes:()=>mt,ArcAvatarText:()=>Et,ArcAvatarTextGapSizes:()=>gt,ArcAvatarTextOverflows:()=>bt,ArcAvatarTextSizes:()=>ft,ArcBadge:()=>Co,ArcBadgeContrasts:()=>ko,ArcBadgeCount:()=>To,ArcBadgeCountShapes:()=>Eo,ArcBadgeCountSizes:()=>_o,ArcBadgeCountVariants:()=>jo,ArcBadgeLayouts:()=>Ao,ArcBadgeSizes:()=>wo,ArcBadgeVariants:()=>zo,ArcButton:()=>Ar,ArcButtonDeprecatedVariants:()=>Re,ArcButtonHierarchies:()=>Ft,ArcButtonLayouts:()=>Nt,ArcButtonShapes:()=>Ht,ArcButtonSizes:()=>Vt,ArcButtonVariants:()=>Ut,ArcCheckbox:()=>Oe,ArcCheckboxBar:()=>Zo,ArcCheckboxBarLayouts:()=>Uo,ArcCheckboxBarOption:()=>Do,ArcCheckboxBarSizes:()=>Fo,ArcCheckboxLayouts:()=>Bo,ArcCheckboxSizes:()=>Ho,ArcCheckboxVariants:()=>Vo,ArcIcon:()=>j,ArcIconText:()=>Nr,ArcIconTextVariants:()=>$o,ArcInputAction:()=>Yo,ArcLabel:()=>br,ArcLabelContent:()=>fr,ArcLabelLayouts:()=>Ro,ArcLink:()=>Wo,ArcLinkVariants:()=>qo,ArcPopover:()=>_a,ArcPopoverAnchors:()=>ye,ArcPopoverBoundaries:()=>we,ArcPopoverButton:()=>aa,ArcPopoverDefaults:()=>rr,ArcPopoverModes:()=>$e,ArcPopoverVariants:()=>za,ArcPopoverVariantsWithOutline:()=>Pt,ArcRadio:()=>Me,ArcRadioBar:()=>ti,ArcRadioBarLayouts:()=>ri,ArcRadioBarOption:()=>ei,ArcRadioBarSizes:()=>ai,ArcRadioLayouts:()=>Ko,ArcRadioSizes:()=>Jo,ArcSwitch:()=>ci,ArcSwitchLabelPositions:()=>Cr,ArcSwitchSizes:()=>oi,ArcSwitchStates:()=>M,ArcSystemAlignments:()=>La,ArcSystemColors:()=>pa,ArcSystemHierarchies:()=>Pa,ArcSystemLayouts:()=>tr,ArcSystemLineHeights:()=>Oa,ArcSystemPopoverModes:()=>da,ArcSystemShapes:()=>la,ArcSystemSizes:()=>G,ArcSystemVariants:()=>D,ArcTextAlignments:()=>mi,ArcTextBodyElements:()=>He,ArcTextBodySizes:()=>ui,ArcTextBodyVariants:()=>vi,ArcTextElements:()=>Ve,ArcTextHeadingElements:()=>Be,ArcTextHeadingSizes:()=>di,ArcTextHeadingVariants:()=>hi,ArcTextInput:()=>Zi,ArcTextInputLayouts:()=>Ni,ArcTextInputSizes:()=>Ui,ArcTextInputTypes:()=>Di,ArcTextInputVariants:()=>Fi,ArcTextKinds:()=>si,ArcTextLineHeights:()=>gi,ArcTextSubheadingSizes:()=>pi,ArcTextTitleSizes:()=>li,ArcToast:()=>Fe,ArcToastPlacements:()=>rn,ArcToastPopoverModes:()=>Qi,ArcToastProgressBarVariants:()=>an,ArcToastSeverities:()=>Gi,ArcToastSizes:()=>Ki,ArcToastVariants:()=>Ji,LogoArticulate:()=>pe,LogoProductAI:()=>he,LogoProductPeek:()=>ue,LogoProductReach:()=>ve,LogoProductReview:()=>me,LogoProductRise:()=>ge,LogoProductStoryline:()=>be,adoptStyles:()=>_,assignRef:()=>Ge,clamp:()=>Ha,css:()=>u,didElementRectChange:()=>Va,extractTextFromReactNode:()=>Br,getPopoverId:()=>je,isDifferent:()=>hr,isSame:()=>Wr,joinArray:()=>tn,makeHtmlId:()=>ir,mapDeprecated:()=>We,pickFromList:()=>$,updatePopoverPosition:()=>Ca});const la=["circle","square","narrow"],D=["inherit","common","disabled","neutral","outline","solid","critical","ai","primary","secondary","tertiary","inverse","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse","overlay-light","overlay-dark","brand-black","brand-blue","brand","info","success","warning"],Pa=["primary","secondary","tertiary","plain"],tr=["hug","fill","icon","gutter","inline"],da=["","auto","manual"],La=["inherit","start","left","justify","center","between","around","evenly","stretch","end","right"],Oa=["inherit","tight","standard","loose"],G=["inherit","xxl","xl","lg","md","sm","xs","xxs"],pa=["blue","orange","mint","red","yellow","green","maroon","purple","neutral","white","black"],ha=["inherit","xl","lg","md","sm","xs"],Ma=["inherit","lg","md","sm"],Ye=["inherit","md","sm"],Ba=["inherit","wrap","truncate"],Xe=["gutter","inline"],qe=["hug","fill"],We=(a,r)=>r[a]||a,$=(a,r)=>a.filter(t=>r.includes(t)),Ge=(a,r)=>{a&&(typeof a=="function"?a(r):a.current=r)},Ha=(a,r=0,t=100)=>Math.min(Math.max(a,r),t),hr=(a,r)=>a!==r,Wr=(a,r)=>a===r,Va=({a,b:r})=>hr(a?.top,r?.top)||hr(a?.left,r?.left)||hr(a?.width,r?.width)||hr(a?.height,r?.height);var i=qr(39291),y=qr(63820);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gr=globalThis,ua=Gr.ShadowRoot&&(Gr.ShadyCSS===void 0||Gr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,va=Symbol(),Na=new WeakMap;class Ua{constructor(r,t,o){if(this._$cssResult$=!0,o!==va)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=r,this.t=t}get styleSheet(){let r=this.o;const t=this.t;if(ua&&r===void 0){const o=t!==void 0&&t.length===1;o&&(r=Na.get(t)),r===void 0&&((this.o=r=new CSSStyleSheet).replaceSync(this.cssText),o&&Na.set(t,r))}return r}toString(){return this.cssText}}const Ke=a=>new Ua(typeof a=="string"?a:a+"",void 0,va),u=(a,...r)=>{const t=a.length===1?a[0]:r.reduce((o,n,c)=>o+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+a[c+1],a[0]);return new Ua(t,a,va)},Je=(a,r)=>{if(ua)a.adoptedStyleSheets=r.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of r){const o=document.createElement("style"),n=Gr.litNonce;n!==void 0&&o.setAttribute("nonce",n),o.textContent=t.cssText,a.appendChild(o)}},Fa=ua?a=>a:a=>a instanceof CSSStyleSheet?(r=>{let t="";for(const o of r.cssRules)t+=o.cssText;return Ke(t)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Qe,defineProperty:rt,getOwnPropertyDescriptor:at,getOwnPropertyNames:et,getOwnPropertySymbols:tt,getPrototypeOf:ot}=Object,Kr=globalThis,Da=Kr.trustedTypes,it=Da?Da.emptyScript:"",nt=Kr.reactiveElementPolyfillSupport,Ir=(a,r)=>a,ma={toAttribute(a,r){switch(r){case Boolean:a=a?it:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,r){let t=a;switch(r){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Za=(a,r)=>!Qe(a,r),Ya={attribute:!0,type:String,converter:ma,reflect:!1,useDefault:!1,hasChanged:Za};Symbol.metadata??=Symbol("metadata"),Kr.litPropertyMetadata??=new WeakMap;class xr extends HTMLElement{static addInitializer(r){this._$Ei(),(this.l??=[]).push(r)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(r,t=Ya){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(r)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(r,t),!t.noAccessor){const o=Symbol(),n=this.getPropertyDescriptor(r,o,t);n!==void 0&&rt(this.prototype,r,n)}}static getPropertyDescriptor(r,t,o){const{get:n,set:c}=at(this.prototype,r)??{get(){return this[t]},set(s){this[t]=s}};return{get:n,set(s){const v=n?.call(this);c?.call(this,s),this.requestUpdate(r,v,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(r){return this.elementProperties.get(r)??Ya}static _$Ei(){if(this.hasOwnProperty(Ir("elementProperties")))return;const r=ot(this);r.finalize(),r.l!==void 0&&(this.l=[...r.l]),this.elementProperties=new Map(r.elementProperties)}static finalize(){if(this.hasOwnProperty(Ir("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ir("properties"))){const t=this.properties,o=[...et(t),...tt(t)];for(const n of o)this.createProperty(n,t[n])}const r=this[Symbol.metadata];if(r!==null){const t=litPropertyMetadata.get(r);if(t!==void 0)for(const[o,n]of t)this.elementProperties.set(o,n)}this._$Eh=new Map;for(const[t,o]of this.elementProperties){const n=this._$Eu(t,o);n!==void 0&&this._$Eh.set(n,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(r){const t=[];if(Array.isArray(r)){const o=new Set(r.flat(1/0).reverse());for(const n of o)t.unshift(Fa(n))}else r!==void 0&&t.push(Fa(r));return t}static _$Eu(r,t){const o=t.attribute;return o===!1?void 0:typeof o=="string"?o:typeof r=="string"?r.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(r=>r(this))}addController(r){(this._$EO??=new Set).add(r),this.renderRoot!==void 0&&this.isConnected&&r.hostConnected?.()}removeController(r){this._$EO?.delete(r)}_$E_(){const r=new Map,t=this.constructor.elementProperties;for(const o of t.keys())this.hasOwnProperty(o)&&(r.set(o,this[o]),delete this[o]);r.size>0&&(this._$Ep=r)}createRenderRoot(){const r=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Je(r,this.constructor.elementStyles),r}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(r=>r.hostConnected?.())}enableUpdating(r){}disconnectedCallback(){this._$EO?.forEach(r=>r.hostDisconnected?.())}attributeChangedCallback(r,t,o){this._$AK(r,o)}_$ET(r,t){const o=this.constructor.elementProperties.get(r),n=this.constructor._$Eu(r,o);if(n!==void 0&&o.reflect===!0){const c=(o.converter?.toAttribute!==void 0?o.converter:ma).toAttribute(t,o.type);this._$Em=r,c==null?this.removeAttribute(n):this.setAttribute(n,c),this._$Em=null}}_$AK(r,t){const o=this.constructor,n=o._$Eh.get(r);if(n!==void 0&&this._$Em!==n){const c=o.getPropertyOptions(n),s=typeof c.converter=="function"?{fromAttribute:c.converter}:c.converter?.fromAttribute!==void 0?c.converter:ma;this._$Em=n;const v=s.fromAttribute(t,c.type);this[n]=v??this._$Ej?.get(n)??v,this._$Em=null}}requestUpdate(r,t,o){if(r!==void 0){const n=this.constructor,c=this[r];if(o??=n.getPropertyOptions(r),!((o.hasChanged??Za)(c,t)||o.useDefault&&o.reflect&&c===this._$Ej?.get(r)&&!this.hasAttribute(n._$Eu(r,o))))return;this.C(r,t,o)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(r,t,{useDefault:o,reflect:n,wrapped:c},s){o&&!(this._$Ej??=new Map).has(r)&&(this._$Ej.set(r,s??t??this[r]),c!==!0||s!==void 0)||(this._$AL.has(r)||(this.hasUpdated||o||(t=void 0),this._$AL.set(r,t)),n===!0&&this._$Em!==r&&(this._$Eq??=new Set).add(r))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const r=this.scheduleUpdate();return r!=null&&await r,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,c]of this._$Ep)this[n]=c;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[n,c]of o){const{wrapped:s}=c,v=this[n];s!==!0||this._$AL.has(n)||v===void 0||this.C(n,void 0,c,v)}}let r=!1;const t=this._$AL;try{r=this.shouldUpdate(t),r?(this.willUpdate(t),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(t)):this._$EM()}catch(o){throw r=!1,this._$EM(),o}r&&this._$AE(t)}willUpdate(r){}_$AE(r){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(r)),this.updated(r)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(r){return!0}update(r){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(r){}firstUpdated(r){}}xr.elementStyles=[],xr.shadowRootOptions={mode:"open"},xr[Ir("elementProperties")]=new Map,xr[Ir("finalized")]=new Map,nt?.({ReactiveElement:xr}),(Kr.reactiveElementVersions??=[]).push("2.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ga=globalThis,Jr=ga.trustedTypes,Xa=Jr?Jr.createPolicy("lit-html",{createHTML:a=>a}):void 0,ba="$lit$",or=`lit$${Math.random().toFixed(9).slice(2)}$`,fa="?"+or,ct=`<${fa}>`,ur=document,Rr=()=>ur.createComment(""),Pr=a=>a===null||typeof a!="object"&&typeof a!="function",xa=Array.isArray,qa=a=>xa(a)||typeof a?.[Symbol.iterator]=="function",$a=`[ 	
\f\r]`,Lr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Wa=/-->/g,Ga=/>/g,vr=RegExp(`>|${$a}(?:([^\\s"'>=/]+)(${$a}*=${$a}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ka=/'/g,Ja=/"/g,Qa=/^(?:script|style|textarea|title)$/i,ya=a=>(r,...t)=>({_$litType$:a,strings:r,values:t}),cn=ya(1),sn=ya(2),ln=ya(3),$r=Symbol.for("lit-noChange"),O=Symbol.for("lit-nothing"),re=new WeakMap,mr=ur.createTreeWalker(ur,129);function ae(a,r){if(!xa(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xa!==void 0?Xa.createHTML(r):r}const ee=(a,r)=>{const t=a.length-1,o=[];let n,c=r===2?"<svg>":r===3?"<math>":"",s=Lr;for(let v=0;v<t;v++){const l=a[v];let h,g,m=-1,f=0;for(;f<l.length&&(s.lastIndex=f,g=s.exec(l),g!==null);)f=s.lastIndex,s===Lr?g[1]==="!--"?s=Wa:g[1]!==void 0?s=Ga:g[2]!==void 0?(Qa.test(g[2])&&(n=RegExp("</"+g[2],"g")),s=vr):g[3]!==void 0&&(s=vr):s===vr?g[0]===">"?(s=n??Lr,m=-1):g[1]===void 0?m=-2:(m=s.lastIndex-g[2].length,h=g[1],s=g[3]===void 0?vr:g[3]==='"'?Ja:Ka):s===Ja||s===Ka?s=vr:s===Wa||s===Ga?s=Lr:(s=vr,n=void 0);const x=s===vr&&a[v+1].startsWith("/>")?" ":"";c+=s===Lr?l+ct:m>=0?(o.push(h),l.slice(0,m)+ba+l.slice(m)+or+x):l+or+(m===-2?v:x)}return[ae(a,c+(a[t]||"<?>")+(r===2?"</svg>":r===3?"</math>":"")),o]};class Or{constructor({strings:r,_$litType$:t},o){let n;this.parts=[];let c=0,s=0;const v=r.length-1,l=this.parts,[h,g]=ee(r,t);if(this.el=Or.createElement(h,o),mr.currentNode=this.el.content,t===2||t===3){const m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(n=mr.nextNode())!==null&&l.length<v;){if(n.nodeType===1){if(n.hasAttributes())for(const m of n.getAttributeNames())if(m.endsWith(ba)){const f=g[s++],x=n.getAttribute(m).split(or),A=/([.?@])?(.*)/.exec(f);l.push({type:1,index:c,name:A[2],strings:x,ctor:A[1]==="."?oe:A[1]==="?"?ie:A[1]==="@"?ne:Mr}),n.removeAttribute(m)}else m.startsWith(or)&&(l.push({type:6,index:c}),n.removeAttribute(m));if(Qa.test(n.tagName)){const m=n.textContent.split(or),f=m.length-1;if(f>0){n.textContent=Jr?Jr.emptyScript:"";for(let x=0;x<f;x++)n.append(m[x],Rr()),mr.nextNode(),l.push({type:2,index:++c});n.append(m[f],Rr())}}}else if(n.nodeType===8)if(n.data===fa)l.push({type:2,index:c});else{let m=-1;for(;(m=n.data.indexOf(or,m+1))!==-1;)l.push({type:7,index:c}),m+=or.length-1}c++}}static createElement(r,t){const o=ur.createElement("template");return o.innerHTML=r,o}}function gr(a,r,t=a,o){if(r===$r)return r;let n=o!==void 0?t._$Co?.[o]:t._$Cl;const c=Pr(r)?void 0:r._$litDirective$;return n?.constructor!==c&&(n?._$AO?.(!1),c===void 0?n=void 0:(n=new c(a),n._$AT(a,t,o)),o!==void 0?(t._$Co??=[])[o]=n:t._$Cl=n),n!==void 0&&(r=gr(a,n._$AS(a,r.values),n,o)),r}class te{constructor(r,t){this._$AV=[],this._$AN=void 0,this._$AD=r,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(r){const{el:{content:t},parts:o}=this._$AD,n=(r?.creationScope??ur).importNode(t,!0);mr.currentNode=n;let c=mr.nextNode(),s=0,v=0,l=o[0];for(;l!==void 0;){if(s===l.index){let h;l.type===2?h=new yr(c,c.nextSibling,this,r):l.type===1?h=new l.ctor(c,l.name,l.strings,this,r):l.type===6&&(h=new ce(c,this,r)),this._$AV.push(h),l=o[++v]}s!==l?.index&&(c=mr.nextNode(),s++)}return mr.currentNode=ur,n}p(r){let t=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(r,o,t),t+=o.strings.length-2):o._$AI(r[t])),t++}}class yr{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(r,t,o,n){this.type=2,this._$AH=O,this._$AN=void 0,this._$AA=r,this._$AB=t,this._$AM=o,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let r=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&r?.nodeType===11&&(r=t.parentNode),r}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(r,t=this){r=gr(this,r,t),Pr(r)?r===O||r==null||r===""?(this._$AH!==O&&this._$AR(),this._$AH=O):r!==this._$AH&&r!==$r&&this._(r):r._$litType$!==void 0?this.$(r):r.nodeType!==void 0?this.T(r):qa(r)?this.k(r):this._(r)}O(r){return this._$AA.parentNode.insertBefore(r,this._$AB)}T(r){this._$AH!==r&&(this._$AR(),this._$AH=this.O(r))}_(r){this._$AH!==O&&Pr(this._$AH)?this._$AA.nextSibling.data=r:this.T(ur.createTextNode(r)),this._$AH=r}$(r){const{values:t,_$litType$:o}=r,n=typeof o=="number"?this._$AC(r):(o.el===void 0&&(o.el=Or.createElement(ae(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===n)this._$AH.p(t);else{const c=new te(n,this),s=c.u(this.options);c.p(t),this.T(s),this._$AH=c}}_$AC(r){let t=re.get(r.strings);return t===void 0&&re.set(r.strings,t=new Or(r)),t}k(r){xa(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let o,n=0;for(const c of r)n===t.length?t.push(o=new yr(this.O(Rr()),this.O(Rr()),this,this.options)):o=t[n],o._$AI(c),n++;n<t.length&&(this._$AR(o&&o._$AB.nextSibling,n),t.length=n)}_$AR(r=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);r!==this._$AB;){const o=r.nextSibling;r.remove(),r=o}}setConnected(r){this._$AM===void 0&&(this._$Cv=r,this._$AP?.(r))}}class Mr{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(r,t,o,n,c){this.type=1,this._$AH=O,this._$AN=void 0,this.element=r,this.name=t,this._$AM=n,this.options=c,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=O}_$AI(r,t=this,o,n){const c=this.strings;let s=!1;if(c===void 0)r=gr(this,r,t,0),s=!Pr(r)||r!==this._$AH&&r!==$r,s&&(this._$AH=r);else{const v=r;let l,h;for(r=c[0],l=0;l<c.length-1;l++)h=gr(this,v[o+l],t,l),h===$r&&(h=this._$AH[l]),s||=!Pr(h)||h!==this._$AH[l],h===O?r=O:r!==O&&(r+=(h??"")+c[l+1]),this._$AH[l]=h}s&&!n&&this.j(r)}j(r){r===O?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,r??"")}}class oe extends Mr{constructor(){super(...arguments),this.type=3}j(r){this.element[this.name]=r===O?void 0:r}}class ie extends Mr{constructor(){super(...arguments),this.type=4}j(r){this.element.toggleAttribute(this.name,!!r&&r!==O)}}class ne extends Mr{constructor(r,t,o,n,c){super(r,t,o,n,c),this.type=5}_$AI(r,t=this){if((r=gr(this,r,t,0)??O)===$r)return;const o=this._$AH,n=r===O&&o!==O||r.capture!==o.capture||r.once!==o.once||r.passive!==o.passive,c=r!==O&&(o===O||n);n&&this.element.removeEventListener(this.name,this,o),c&&this.element.addEventListener(this.name,this,r),this._$AH=r}handleEvent(r){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,r):this._$AH.handleEvent(r)}}class ce{constructor(r,t,o){this.element=r,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(r){gr(this,r)}}const dn={M:ba,P:or,A:fa,C:1,L:ee,R:te,D:qa,V:gr,I:yr,H:Mr,N:ie,U:ne,B:oe,F:ce},st=ga.litHtmlPolyfillSupport;st?.(Or,yr),(ga.litHtmlVersions??=[]).push("3.3.1");const lt=(a,r,t)=>{const o=t?.renderBefore??r;let n=o._$litPart$;if(n===void 0){const c=t?.renderBefore??null;o._$litPart$=n=new yr(r.insertBefore(Rr(),c),c,void 0,t??{})}return n._$AI(a),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wa=globalThis;class Qr extends xr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const r=super.createRenderRoot();return this.renderOptions.renderBefore??=r.firstChild,r}update(r){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(r),this._$Do=lt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return $r}}Qr._$litElement$=!0,Qr.finalized=!0,wa.litElementHydrateSupport?.({LitElement:Qr});const dt=wa.litElementPolyfillSupport;dt?.({LitElement:Qr});const pn={_$AK:(a,r,t)=>{a._$AK(r,t)},_$AL:a=>a._$AL};(wa.litElementVersions??=[]).push("4.2.1");const se={};function _(a,r){if(typeof document<"u"&&r?.styleSheet){const t=se[a];se[a]=r.styleSheet,document.adoptedStyleSheets=[...document.adoptedStyleSheets.filter(o=>o!==t),r.styleSheet]}}const b=u`arc•avatar`,R=u`arc•modifier`,V=u`${b}•computed`,ar=u`${b}•mask`,pt=a=>a?.trim().charAt(0)??void 0,ht=(a,r)=>{let t=0;const o=Math.min(a.length,50);for(let n=0;n<o;n+=1)t=(t+a.charCodeAt(n))%(r??33);return t},ut=(a,r,t)=>r?.length?a?.trim()===""?t||r[0]:r[ht(a,r.length)]||t||r[0]:t,le=$(pa,["blue","orange","mint","red","yellow","green","maroon","purple"]),vt=$(pa,["neutral","white","black"]),ra=$(G,["lg","md","sm","xs"]),mt=[...ra,"profile-sm","profile-md","profile-lg"],gt=Ma,bt=Ba,ft=ra,xt=ra,$t=ra,Aa=u`

  &[data-size=xs] {
    --${R}: 10; /* unitless, desired size at 100% */
    --${b}-num-size-1: 10;
    --${b}-num-size-2: 8;
    --${b}-num-size-3: 6;
    --${b}-size: 20;
  ...
  &[data-size=sm] {
    --${R}: 12; /* unitless, desired size at 100% */
    --${b}-num-size-1: 12;
    --${b}-num-size-2: 10;
    --${b}-num-size-3: 8;
    --${b}-size: 24;
  ...
  &:is([data-size=md], [data-size=inherit], :not([data-size])) { /* @default size */
    --${R}: 14; /* unitless, desired size at 100% */
    --${b}-num-size-1: 14;
    --${b}-num-size-2: 12;
    --${b}-num-size-3: 10;
    --${b}-size: 32;
  ...
  &[data-size=lg] {
    --${R}: 16; /* unitless, desired size at 100% */
    --${b}-num-size-1: 16;
    --${b}-num-size-2: 14;
    --${b}-num-size-3: 12;
    --${b}-size: 40;
...
[arc-avatar] {
  ...
  &[data-size=profile-sm] {
    --${R}: 28; /* unitless, desired size at 100% */
    --${b}-size: 64;
  }

  &[data-size=profile-md] {
    --${R}: 32; /* unitless, desired size at 100% */
    --${b}-size: 96;
  }

  &[data-size=profile-lg] {
    --${R}: 40; /* unitless, desired size at 100% */
    --${b}-size: 160;
  }
  ...
  --${V}-font-size: calc(var(--${R}-px));
  --${V}-size: calc(var(--${b}-size) / var(--${R}-em));
  --${V}-num-size-1: calc(var(--${b}-num-size-1) / var(--${R}-em));
  --${V}-num-size-2: calc(var(--${b}-num-size-2) / var(--${R}-em));
  --${V}-num-size-3: calc(var(--${b}-num-size-3) / var(--${R}-em));
}
...
`,zt=a=>typeof a=="number"?`calc(${a/10}rem * var(--arc-internal-font-size))`:a,j=({children:a,icon:r="fa-regular fa-circle-dashed",color:t,size:o,style:n,...c})=>{const s={...n,"--arc-icon-size":zt(o),"--arc-icon-color":t},v=!!(c["aria-label"]||c["aria-labelledby"]),l=typeof r=="string"&&r.length>0?(0,i.jsx)("span",{className:r}):r;return(0,i.jsx)("span",{"aria-hidden":!v||void 0,...c,"arc-icon":"",style:s,children:a||l})};j.Articulate=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(pe,{})}),j.AI=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(he,{})}),j.Peek=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(ue,{})}),j.Reach=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(ve,{})}),j.Review=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(me,{})}),j.Rise=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(ge,{})}),j.Storyline=a=>(0,i.jsx)(j,{...a,icon:(0,i.jsx)(be,{})}),_("ArcIcon",kt);const Ct=({children:a,icon:r,color:t,...o})=>(0,i.jsx)("span",{...o,"data-element":"anonymous","data-color":"neutral",children:a||(0,i.jsx)(j,{icon:r})}),fe="blue",xe="neutral",St="fa-solid fa-user",ka=(0,y.forwardRef)(({children:a,size:r,color:t,isActive:o=!0,isAnonymous:n,alt:c,src:s,name:v,email:l,...h},g)=>{const[m,f]=(0,y.useState)(!1),[x,A]=(0,y.useState)(!1),T=W=>{f(!0),A(!1),h.onLoad?.(W)},B=W=>{f(!1),A(!0),h.onError?.(W)},I=pt(v||l),C=!!I,k=n||(!m||x)&&!C,H=!k&&!!s&&!x||void 0,J=(k&&xe||void 0)??(t||void 0)??ut(String(l||v||void 0),le,fe)??fe,lr={src:s,alt:c,isLoaded:m,hasError:x,onLoad:T,onError:B};return(0,y.useEffect)(()=>{k&&f(!1)},[k]),(0,i.jsx)("span",{...h,ref:g,"arc-avatar":"","data-is-inactive":!o||void 0,"data-size":r,"aria-label":(h.title??v??l)||void 0,children:a||(k?(0,i.jsx)(Ct,{icon:St,color:xe}):(0,i.jsxs)(i.Fragment,{children:[H&&(0,i.jsx)(At,{...lr}),C&&(0,i.jsx)(wt,{initial:I,color:J})]}))})});_("ArcAvatar",yt);const F=u`${b}•text`,dr=u`${b}•subtext`,wr=u`${b}•gap`,_t=u`
@layer arc-components {

  [arc-avatar-text] {
    --${F}-font-size: max(var(--arc-font-size-14), 0.875em); /* 14px @ 100% */
    --${dr}-font-size: max(var(--arc-font-size-12), 0.75em); /* 12px @ 100% */
    --${wr}: max(var(--arc-space-1), 0.5em); /* 8px @ 100% */
    ...
    &:has([data-size=xs]) {
      ...
      --${dr}-font-size: var(--arc-font-size-12);
      --${wr}: var(--arc-space-0-75);
    }

    &[data-gap=lg] { --${wr}: var(--arc-space-1-5); }
    &[data-gap=sm] { --${wr}: var(--arc-space-0-5); }
  }
...
`,jt="Anonymous",Et=({children:a,avatar:r={},subtext:t,size:o,gapSize:n,overflow:c,isStrong:s,...v})=>{const l=r.anonymousName||jt,h=r.name||r.email||r.src,g=r.name||r.email,m=r.isAnonymous||!h,f=a||m?l:g,x=n!=="inherit"?n:void 0,A=c!=="inherit"?c:void 0;return(0,i.jsxs)("span",{...v,"arc-avatar-text":"","data-gap":x,"data-overflow":A,"is-strong":s?"":void 0,children:[(0,i.jsx)(ka,{...r,isAnonymous:m,size:o}),(0,i.jsxs)("span",{"data-element":"text",children:[f,t&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("br",{}),(0,i.jsx)("small",{"data-element":"subtext",children:t})]})]})]})};_("ArcAvatarText",_t);const Tt=u`
@layer arc-components {
  ...
  [arc-avatar-pile] {
    ...
    /* OVERLAP MASK --------------------------------------------------•
       --${R} comes from avatarSizesShared
    */

    --${R}-em: var(--${R}) * 1em;
    --${V}-offset: calc(2 / var(--${R}-em));
    --${V}-mask-shift: calc(-2 / var(--${R}-em));
...
`,It=({size:a="md",...r})=>(0,i.jsx)("div",{...r,"arc-avatar-pile":"","data-size":a});_("ArcAvatarPile",Tt);const Br=a=>typeof a=="string"?a:typeof a=="number"?a.toString():Array.isArray(a)?a.map(Br).join(""):(0,y.isValidElement)(a)?Br(a.props.children):"",Rt=()=>Math.random().toString(16).slice(-6),ir=a=>`${a||"id"}-${Rt()}`,$e=[...da],za=$(D,["common"]),Pt=$(D,["ai","brand"]),ye=["top-start","top-center","top-end","left-start","right-start","left-center","center","right-center","left-end","right-end","bottom-start","bottom-center","bottom-end"],we=["ignore","flip"],w={Threshold:0,StartX:{align:"start",y:"y1",oY:"ch",xMod:-1,yMod:1},StartY:{align:"start",x:"x1",oX:"cw",xMod:-1,yMod:1},CenterX:{align:"center",y:"cy",oY:"z",xMod:-1,yMod:1},CenterY:{align:"center",x:"cx",oX:"z",xMod:1,yMod:-1},EndX:{align:"end",y:"y2",oY:"ch",xMod:1,yMod:-1},EndY:{align:"end",x:"x2",oX:"cw",xMod:1,yMod:-1},Top:{edge:"top",y:"top",pX:"z",pY:"ch",oY:"z",pMod:-1},Bottom:{edge:"bottom",y:"bottom",pX:"z",pY:"ch",oY:"z",pMod:1},Right:{edge:"right",x:"right",pX:"cw",pY:"z",oX:"z",pMod:1},Left:{edge:"left",x:"left",pX:"cw",pY:"z",oX:"z",pMod:-1},Center:{edge:"center",pX:"cw",pY:"ch",pMod:0}},K=(a,r,t)=>t==="left"&&a.a.left>=a.v.threshold&&a.a.left-a.p.width+r.x>=a.v.threshold||t==="top"&&a.a.top>=a.v.threshold&&a.a.top-a.p.height+r.y>=a.v.threshold||t==="right"&&a.a.right<=a.v.width-a.v.threshold&&a.a.right+a.p.width+r.x<=a.v.width-a.v.threshold||t==="bottom"&&a.a.bottom<=a.v.height-a.v.threshold&&a.a.bottom+a.p.height+r.y<=a.v.height-a.v.threshold,Ae=(a,r)=>a.a.top+a.p.height+r.y<=a.v.height-a.v.threshold&&a.a.top>=a.v.threshold,ke=(a,r)=>a.a.left+a.p.width+r.x<=a.v.width-a.v.threshold&&a.a.left>=a.v.threshold,ze=(a,r)=>a.a.cy+a.p.ch+r.y<=a.v.height-a.v.threshold&&a.a.cy-a.p.ch+r.y>=a.v.threshold,Ce=(a,r)=>a.a.cx+a.p.cw+r.x<=a.v.width-a.v.threshold&&a.a.cx-a.p.cw+r.x>=a.v.threshold,Se=(a,r)=>a.a.bottom<=a.v.height-a.v.threshold&&a.a.bottom-a.p.height+r.y>=a.v.threshold,_e=(a,r)=>a.a.right<=a.v.width-a.v.threshold&&a.a.right-a.p.width+r.x>=a.v.threshold,Hr={"top-start":{...w.Top,...w.StartY,fitCheck:(a,r)=>K(a,r,w.Top.edge)&&ke(a,r),flip:"bottom-start"},"top-center":{...w.Top,...w.CenterY,fitCheck:(a,r)=>K(a,r,w.Top.edge)&&Ce(a,r),flip:"bottom-center"},"top-end":{...w.Top,...w.EndY,fitCheck:(a,r)=>K(a,r,w.Top.edge)&&_e(a,r),flip:"bottom-end"},"right-start":{...w.Right,...w.StartX,fitCheck:(a,r)=>K(a,r,w.Right.edge)&&Ae(a,r),flip:"left-start"},"right-center":{...w.Right,...w.CenterX,fitCheck:(a,r)=>K(a,r,w.Right.edge)&&ze(a,r),flip:"left-center"},"right-end":{...w.Right,...w.EndX,fitCheck:(a,r)=>K(a,r,w.Right.edge)&&Se(a,r),flip:"left-end"},center:{...w.Center,...w.CenterX,...w.CenterY,fitCheck:(a,r)=>a.a.cx-a.p.cw+r.x>=a.v.threshold&&a.a.cx+a.p.cw+r.x<=a.v.width-a.v.threshold&&a.a.cy-a.p.ch+r.y>=a.v.threshold&&a.a.cy+a.p.ch+r.y<=a.v.height-a.v.threshold,flip:"center"},"bottom-start":{...w.Bottom,...w.StartY,fitCheck:(a,r)=>K(a,r,w.Bottom.edge)&&ke(a,r),flip:"top-start"},"bottom-center":{...w.Bottom,...w.CenterY,fitCheck:(a,r)=>K(a,r,w.Bottom.edge)&&Ce(a,r),flip:"top-center"},"bottom-end":{...w.Bottom,...w.EndY,fitCheck:(a,r)=>K(a,r,w.Bottom.edge)&&_e(a,r),flip:"top-end"},"left-start":{...w.Left,...w.StartX,fitCheck:(a,r)=>K(a,r,w.Left.edge)&&Ae(a,r),flip:"right-start"},"left-center":{...w.Left,...w.CenterX,fitCheck:(a,r)=>K(a,r,w.Left.edge)&&ze(a,r),flip:"right-center"},"left-end":{...w.Left,...w.EndX,fitCheck:(a,r)=>K(a,r,w.Left.edge)&&Se(a,r),flip:"right-end"}},rr={popover:$e[0],anchorAt:ye[10],boundary:we[0],variant:za[0],isInverse:!1,hasTail:!1,tailSize:10,threshold:0,offset:0},je=(a,r="arc-popover")=>a||ir(r),Lt=(a=rr.threshold)=>({threshold:a,width:document.documentElement.clientWidth,height:document.documentElement.clientHeight,scrollX:window.scrollX,scrollY:window.scrollY,left:window.scrollX,top:window.scrollY,right:window.scrollX+document.documentElement.clientWidth,bottom:window.scrollY+document.documentElement.clientHeight}),Ee=a=>({...JSON.parse(JSON.stringify(a)),cw:a.width/2,ch:a.height/2,cx:a.left+a.width/2,cy:a.top+a.height/2,x1:a.left,x2:a.left+a.width,y1:a.top,y2:a.top+a.height,z:0}),Ot=(a,r,t=rr.offset,o=rr.tailSize,n=rr.threshold)=>({a:Ee(a?.getBoundingClientRect()??new DOMRect),p:Ee(r?.getBoundingClientRect()??new DOMRect),o:t,v:Lt(n),t:o}),Te=(a,r,t)=>({x:["left","right"].includes(a)?r*t:0,y:["top","bottom"].includes(a)?r*t:0}),Mt=(a,r)=>[...Object.keys(Hr)].filter(t=>hr(t,a)&&hr(r.align,"center")?!t.includes("center"):t).sort((t,o)=>{const n=Wr(Hr[t].edge,r.edge),c=Wr(Hr[o].edge,r.edge),s=n?-1:1;return Wr(n,c)?0:s}),Ie=({anchorAt:a,measurements:r})=>{const t=Hr[a],o=Te(t.edge,r.o,t.pMod);return{cx:r.a.cx,cy:r.a.cy,offsets:o,config:t}},Bt=({anchorAt:a,measurements:r})=>{const{offsets:t,config:o}=Ie({anchorAt:a,measurements:r});return o.fitCheck(r,t)?a:[o.flip,...Mt(a,o)].find(n=>{const c=Hr[n],s=Te(c.edge,r.o,c.pMod);return c.fitCheck(r,s)})??a},nr=(a,r="px")=>`${a}${r}`,Ca=({anchorElement:a,popoverElement:r,anchorAt:t=rr.anchorAt,boundary:o,offset:n,tailSize:c,threshold:s=w.Threshold})=>{const v=t,l=Ot(a,r,n,c,s),h=o==="flip"?Bt({anchorAt:v,measurements:l}):v,{cx:g,cy:m}=Ie({anchorAt:h,measurements:l}),f={cx:g,cy:m},x=a?.dataset?.layout==="icon"||l.t>0||!t?.includes("-center")&&(t?.includes("left-")||t?.includes("right-"));return{anchorAt:h,vars:{"--js-cx":nr((f.cx+window.scrollX).toFixed(2)),"--js-cy":nr((f.cy+window.scrollY).toFixed(2)),"--js-w":nr(l.a.width.toFixed(2)),"--js-h":nr(l.a.height.toFixed(2)),"--js-cw":nr(l.a.cw.toFixed(2)),"--js-ch":nr(l.a.ch.toFixed(2)),"--js-o":nr(l.o.toFixed(2)),"--js-t":nr(l.t,""),"--js-i":x?"1":"0","--js-m":nr(Ha(l.t,l.a.height,l.a.cw).toFixed(2))}}},Ht=$(la,["circle","square","narrow"]),Vt=$(G,["xxl","xl","lg","md","sm"]),Nt=$(tr,["hug","fill","icon"]),Ut=$(D,["common","ai","critical"]),Re=$(D,["primary","secondary","tertiary","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse"]),Ft=$(Pa,["primary","secondary","tertiary","plain"]),e=u`arc•button`,P=u`arc•modifier`,z=u`${e}•computed`,Dt=u`
  &[data-size=xxl] {
...
`,Gt=u`
  ...
  --${z}-font-size: calc(var(--${P}-base));
  --${z}-icon-size: calc(var(--${e}-icon-size) / var(--${P}-em));
  --${z}-border-size: max(var(--arc-border-width-sm), calc(1 / var(--${P}-em)));
  --${z}-outline-size: max(var(--arc-border-width-md), calc(2 / var(--${P}-em)));
  --${z}-border-radius-md: max(var(--arc-border-radius-md), calc(4 / var(--${P}-em)));
  --${z}-height: calc(var(--${e}-height) / var(--${P}-em));
  --${z}-padding: 0 calc(var(--${e}-padding-inline) / var(--${P}-em));
  --${z}-spinner-size: calc(var(--${e}-spinner-size) / var(--${P}-em));
  --${z}-gap: max(var(--arc-space-0-5), calc(var(--${e}-gap) / var(--${P}-em)));
  ...
  &[data-variant^=ai-] {
    --${z}-border-size: max(var(--arc-border-width-md), calc(2 / var(--${P}-em)));
  }
...
`,Qt=(0,i.jsxs)("svg",{viewBox:"0 0 100 100","arc-spinner":"",children:[(0,i.jsx)("circle",{"arc-spinner-circle":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"}),(0,i.jsx)("circle",{"arc-spinner-progress":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"})]}),Ar=(0,y.forwardRef)(({children:a,...r},t)=>{const{iconEnd:o,iconStart:n,icon:c,text:s,isActive:v,isDisabled:l,isProcessing:h,tag:g,href:m,type:f,title:x,layout:A,shape:T,size:B="lg",variant:I="common",hierarchy:C="primary",isInverse:k=!1,_isCustom:H,...J}=r,lr=I&&Re.includes(I),W=(()=>{if(lr||!["common","critical","ai"].includes(I))return I;const Yr=C||"primary";return I==="common"?k?`${Yr}-inverse`:Yr:`${I}-${Yr}`})(),er=A==="icon",_r=g??(m?"a":"button"),Ea=_r==="button"?f||"button":void 0,Dr=h||l||r.disabled,ia=n||c,Zr=!er&&(a||s),jr=!er&&o;return(0,i.jsxs)(_r,{...J,ref:t,"arc-button":H?"custom":"",href:m||void 0,title:x||void 0,type:Ea,"data-layout":A,"data-shape":H?void 0:T,"data-size":H?void 0:B,"data-variant":H?void 0:W,"is-active":v?"":void 0,"is-processing":h?"":void 0,"is-disabled":Dr?"":void 0,"aria-disabled":Dr||void 0,children:[(0,i.jsxs)("span",{"arc-button-content":"",children:[!!ia&&(0,i.jsx)(j,{"arc-button-icon":"",icon:ia}),!!Zr&&(0,i.jsx)("span",{"arc-button-label":"",children:Zr}),!!jr&&(0,i.jsx)(j,{"arc-button-icon":"",icon:o})]}),h&&Qt]})});Ar.displayName="ArcButton",_("ArcButton",Jt);const aa=(0,y.forwardRef)((a,r)=>(0,i.jsx)(Ar,{...a,ref:r,"arc-popover-button":""})),Pe=({isInverse:a=!1,isOpen:r,...t})=>(0,i.jsx)(Ar,{...t,icon:"fa-regular fa-xmark fa-fw",text:"Dismiss",layout:"icon",shape:"square",size:"sm",variant:"common",hierarchy:"tertiary",isInverse:a,"arc-popover-dismiss":""}),ro=({children:a,showDismiss:r,dismissProps:t,tag:o="header",...n})=>(0,i.jsxs)(o,{...n,"arc-popover-header":"",children:[a,r&&(0,i.jsx)(Pe,{...t})]}),ao=({tag:a="article",...r})=>(0,i.jsx)(a,{...r,"arc-popover-body":""}),eo=({showDivider:a,tag:r="footer",...t})=>(0,i.jsx)(r,{...t,"arc-popover-footer":"","has-divider":a?"":void 0}),to=a=>(0,i.jsx)("span",{...a,"arc-popover-tail":""});aa.displayName="ArcPopoverButton";const d=u`arc•popover`,S=u`${d}•space`,Y=u`${d}•shift`,kr=u`${d}•offset`,Z=u`${d}•outline`,Le=u`${d}•header`,ea=u`${d}•body`,Vr=u`${d}•footer`,p=u`${d}•tail`,oo=u`
  --${d}-border-radius: var(--arc-popover-border-radius, var(--arc-border-radius-lg));
  --${d}-inner-border-radius: calc(var(--${d}-border-radius) - var(--${Z}-size));
  ...
  --${Z}-size: var(--arc-popover-outline-size, var(--${S}-2));

  /* tail metrics */
  --${p}-base: max(var(--js-t, 10) * 1px, 0.625em);
  --${p}-size: (var(--${p}-base) + var(--${Z}-size));

  /* 0.707 = sqrt(2)/2 = multiplier for half of rotated tail size (used in offset calcs) */
  --${p}-shift: (var(--${p}-base) * 0.707 * var(--js-i));

  /* offset */
  --${kr}-x: calc(var(--js-cw) + var(--js-o) + var(--arc-popover-nudge, 0em));
  --${kr}-y: calc(var(--js-ch) + var(--js-o) + var(--arc-popover-nudge, 0em));
  --${Y}-x: calc(var(--js-cw) + var(--${p}-shift));
  --${Y}-y: calc(var(--js-ch) + var(--${p}-shift));
  ...
  &:has([arc-popover-body]) {
    --${d}-padding: 0;
    &:has([arc-popover-header]) { --${ea}-padding-block-start: 0; }
    &:has([arc-popover-footer]:not([has-divider])) { --${ea}-padding-block-end: 0; }
  }
  ...
  &:has([arc-popover-tail]) {
    ...
    --${p}-clamp: clamp(
      var(--${p}-shift),
      var(--js-h) - (var(--${p}-shift) * 2),
      var(--js-cw) - (var(--${Z}-size) * 2)
    );
  }
`,io=u`
  &:where([arc-popover*=top], [arc-popover*=bottom]) {
    --${d}-min-width: calc(var(--js-w) + ((var(--${p}-shift) - var(--${Z}-size)) * 2));
    --${d}-min-height: auto;
  }
  ...
  &:where([arc-popover*=top]) {
    --${d}-tr: var(--${p}-radius) 0;
    --${d}-ty: calc(-100% - var(--${kr}-y));
    --${p}-ty: 50%;

    &:where([arc-popover*=-start]) {
      --${d}-trail-mix: 87.5%;
      --${d}-tx: calc(0% - var(--${Y}-x));
      --${p}-inset: auto auto var(--${p}-nudge) calc(0% + var(--${p}-clamp));
      --${p}-tx: 50%;
    }
    ...
    &:where([arc-popover*=-center]) {
      --${d}-trail-mix: 75%;
      --${d}-tx: -50%;
      --${p}-inset: auto auto var(--${p}-nudge) 50%;
      --${p}-tx: -50%;
    }

    &:where([arc-popover*=-end]) {
      --${d}-trail-mix: 62.5%;
      --${d}-tx: calc(-100% + var(--${Y}-x));
      --${p}-inset: auto auto var(--${p}-nudge) calc(100% - var(--${p}-clamp));
      --${p}-tx: -150%;
    }
  }
  ...
  &:where([arc-popover*=right]) {
    --${d}-tr: 0 var(--${p}-radius);
    --${d}-tx: calc(0% + var(--${kr}-x));
    --${p}-tx: -50%;

    &:where([arc-popover*=-start]) {
      --${d}-trail-mix: 62.5%;
      --${d}-ty: calc(0% - var(--${Y}-y));
      --${p}-ty: calc(50% + var(--${Y}-y));
      --${p}-inset: auto auto 100% var(--${p}-nudge);
    }
    ...
    &:where([arc-popover*=-center]) {
      ...
      --${d}-ty: -50%;
      --${p}-ty: 50%;
      --${p}-inset: auto auto 50% var(--${p}-nudge);
    }

    &:where([arc-popover*=-end]) {
      --${d}-trail-mix: 87.5%;
      --${d}-ty: calc(-100% + var(--${Y}-y));
      --${p}-ty: calc(50% - var(--${Y}-y));
      --${p}-inset: auto auto 0% var(--${p}-nudge);
    }
  }
  ...
  &:where([arc-popover=center]) {
    ...
    --${p}-size: 0em;
    --${p}-display: none;
    --${p}-display-duration: 0ms;
  }

  &:where([arc-popover*=bottom]) {
    --${d}-tr: var(--${p}-radius) 0;
    --${d}-ty: calc(0% + var(--${kr}-y));
    --${p}-ty: -50%;
    ...
    &:where([arc-popover*=-start]) {
      ...
      --${d}-tx: calc(0% - var(--${Y}-x));
      --${p}-tx: 50%;
      --${p}-inset: var(--${p}-nudge) auto auto calc(0% + var(--${p}-clamp));
    }
    ...
    &:where([arc-popover*=-center]) {
      ...
      --${d}-tx: -50%;
      --${p}-tx: -50%;
      --${p}-inset: var(--${p}-nudge) auto auto 50%;
    }
    ...
    &:where([arc-popover*=-end]) {
      ...
      --${d}-tx: calc(-100% + var(--${Y}-x));
      --${p}-tx: -150%;
      --${p}-inset: var(--${p}-nudge) auto auto calc(100% - var(--${p}-clamp));
    }
  }

  &:where([arc-popover*=left]) {
    --${d}-tr: 0 var(--${p}-radius);
    --${d}-tx: calc(-100% - var(--${kr}-x));
    --${p}-tx: 50%;
    ...
    &:where([arc-popover*=-start]) {
      ...
      --${d}-ty: calc(0% - var(--${Y}-y));
      --${p}-ty: calc(50% + var(--${Y}-y));
      --${p}-inset: auto var(--${p}-nudge) 100% auto;
    }
    ...
    &:where([arc-popover*=-center]) {
      ...
      --${d}-ty: -50%;
      --${p}-ty: 50%;
      --${p}-inset: auto var(--${p}-nudge) 50% auto;
    }
    ...
    &:where([arc-popover*=-end]) {
      ...
      --${d}-ty: calc(-100% + var(--${Y}-y));
      --${p}-ty: calc(50% - var(--${Y}-y));
      --${p}-inset: auto var(--${p}-nudge) 0% auto;
    }
  }
...
`,no=u`
  ...
  &[variant] {
    --${d}-color: var(--arc-color-text-primary);
    --${d}-background: var(--arc-color-background-primary);
    --${Vr}-divider-color: var(--arc-color-border-standard);
    --${Z}-color: var(--${d}-background);
    --${p}-background: var(--${Z}-color);
    --${p}-outline-color: var(--${Z}-color);
    --${p}-border: solid var(--${Z}-size) var(--${p}-outline-color);
    --${d}-shadow: var(--arc-shadow-light-lg);
  }

  &[variant=common][is-inverse] {
    --${d}-color: var(--arc-color-text-inverse);
    --${d}-background: var(--arc-color-background-inverse);
    --${d}-shadow: var(--arc-shadow-dark-lg);
  ...
  &[variant=brand] {
    ...
    --${Z}-color: var(--arc-color-border-brand);
  }

  &[variant=ai] {
    --${d}-background: var(--arc-color-ai-blue-050) var(--arc-gradient-ai-050);
    --${Z}-color: var(--arc-gradient-ai-200);
    --${p}-background: color-mix(in srgb,
      var(--arc-color-ai-purple-050) var(--${d}-trail-mix, 37.5%),
      var(--arc-color-ai-blue-050) clamp(0%, 100% - var(--${d}-trail-mix, 37.5%), 100%)
    );
    --${p}-outline-color: color-mix(in srgb,
      var(--arc-color-ai-purple-200) var(--${d}-trail-mix, 37.5%),
      var(--arc-color-ai-blue-200) clamp(0%, 100% - var(--${d}-trail-mix, 37.5%), 100%)
    );
  }
`,co=u`
  [arc-popover] {
    ...
    */
    ...
    padding: var(--${Z}-size);
    background: var(--arc-popover-outline-color, var(--${Z}-color));
    border-radius: var(--${d}-border-radius);
    border: none;
    box-shadow: var(--arc-popover-shadow, var(--${d}-shadow));
    margin: 0;
    ...
    [arc-popover-content] {
      ...
      color: var(--arc-popover-color, var(--${d}-color));
      padding: var(--arc-popover-padding, var(--${d}-padding));
      background: var(--arc-popover-background, var(--${d}-background));
      border-radius: var(--${d}-inner-border-radius);
      ...
      min-width: var(--arc-popover-min-width, var(--${d}-min-width));
      min-height: var(--arc-popover-min-height, var(--${d}-min-height));
    ...
    [arc-popover-header] {
      ...
      gap: var(--arc-popover-header-gap, var(--${Le}-gap));
    ...
    [arc-popover-body] {
      ...
      padding: var(--arc-popover-body-padding,
        var(--${ea}-padding-block-start, var(--${S}-12))
        var(--${S}-12)
        var(--${ea}-padding-block-end, var(--${S}-12))
        var(--${S}-12)
      );
    }
    ...
    [arc-popover-tail] {
      ...
      border-radius: var(--${d}-tr);
    }
  }

`,ta={SETUP:oo,POSITION:io,VARIANTS:no,ELEMENTS:co},so=u`
@layer arc-components {
  [arc-popover] {
    ${ta.SETUP}
    ${ta.POSITION}
...
`,lo=(a,r)=>{const t=document.getElementById(a);({toggle:()=>t?.togglePopover(),show:()=>t?.showPopover(),hide:()=>t?.hidePopover()})[r??"toggle"]()},Sa=(0,y.forwardRef)(({children:a,popover:r=rr.popover,alternateAnchor:t,anchorProps:o,anchorAt:n,boundary:c,variant:s=rr.variant,isInverse:v,hasTail:l,tailSize:h=rr.tailSize,offset:g=rr.offset,hidePopoverButton:m,headerSlot:f,showDismiss:x,dismissProps:A,footerSlot:T,showFooterDivider:B,tag:I="div",contentTag:C="div",onToggle:k,...H},J)=>{const lr=(0,y.useRef)(null),W=(0,y.useRef)(null);(0,y.useImperativeHandle)(J,()=>W.current);const[er,_r]=(0,y.useState)(!1),[Ea,Dr]=(0,y.useState)(n||rr.anchorAt),[ia,Zr]=(0,y.useState)({}),[jr,Yr]=(0,y.useState)(0),[na,on]=(0,y.useState)(l?g??0:0),Ta=(0,y.useMemo)(()=>v&&[...za].includes(s),[s,v]),ca=(0,y.useMemo)(()=>({popovertarget:H.id,"aria-haspopup":!0,"aria-controls":H.id,"aria-expanded":er}),[H.id,er]),De=(0,y.useMemo)(()=>({isInverse:Ta,isOpen:er,"aria-label":"Dismiss",...ca,...A}),[A,Ta,er,ca]),Ia=(0,y.useMemo)(()=>({ref:lr,...ca,...o}),[lr,o,ca]),Er=(0,y.useMemo)(()=>typeof t=="function"?t(Ia):typeof t=="string"?document.getElementById(t):lr.current,[t,Ia]),sa=(0,y.useCallback)(({...Q})=>{Dr(Q.anchorAt),Zr(Q.vars)},[Dr,Zr]);return(0,y.useEffect)(()=>{const Q=l?h??0:0,pr=Number(g??0)+Q*(Math.sqrt(2)/2);Yr(Q),on(pr)},[l,h,g]),(0,y.useEffect)(()=>{const Q=W?.current;if(!Er)return;let pr=null,Xr=null,Tr=null;const Ze=()=>{pr=Er?.getBoundingClientRect()??{},Tr&&Va({a:pr,b:Xr})?(Xr=pr,sa(Ca({anchorElement:Er,popoverElement:Q,anchorAt:n,boundary:c,offset:na,tailSize:jr}))):Tr=null,Tr=requestAnimationFrame(Ze)};Tr=requestAnimationFrame(Ze)},[Er,er,n,c,na,jr,sa]),(0,y.useEffect)(()=>{const Q=W.current;if(!Q)return;const pr=Xr=>{const{newState:Tr}=Xr;_r(Tr==="open"),sa(Ca({anchorElement:Er,popoverElement:Q,anchorAt:n,boundary:c,offset:na,tailSize:jr})),k?.(Xr)};return Q.addEventListener("toggle",pr),()=>{Q.removeEventListener("toggle",pr)}},[W,k,Er,n,c,na,jr,sa]),(0,i.jsxs)(i.Fragment,{children:[!(t&&m)&&(0,i.jsx)(aa,{...Ia}),(0,i.jsxs)(I,{...H,role:H.role??"dialog","arc-popover":Ea,ref:W,popover:r,boundary:c,variant:s,"is-inverse":Ta?"":void 0,"has-tail":l?"":void 0,style:{...H.style,...ia},children:[l&&(0,i.jsx)(to,{}),(0,i.jsxs)(C,{"arc-popover-content":"",children:[!!f&&(0,i.jsx)(ro,{showDismiss:x,dismissProps:De,children:f}),f||T?(0,i.jsx)(ao,{children:a}):a,!!T&&(0,i.jsx)(eo,{showDivider:B,children:T})]}),x&&!f&&(0,i.jsx)(Pe,{...De})]})]})});Sa.handlePopover=lo,Sa.Button=aa;const _a=Sa;_("ArcPopover",so);const po=u`
@layer arc-components {
...
`,ho=a=>(0,i.jsx)("ul",{...a,"data-element":"list"}),uo=a=>(0,i.jsx)("li",{...a,"data-element":"list-item"}),vo=({count:a,anchorId:r,overflowId:t,shouldShowOverflow:o,...n})=>(0,i.jsx)(ka,{title:`+${a}`,children:(0,i.jsx)(_a.Button,{...n,id:r,popovertarget:t,text:`+${a}`,variant:"common",hierarchy:"primary",disabled:!o,"data-element":"counter","data-color":"black","data-num-length":a?.toString().length})}),mo=({children:a,id:r,size:t="sm",overflowCount:o=0,shouldShowOverflow:n=!1,anchorAt:c="bottom-end",boundary:s="flip",...v})=>{const l=Math.min(o,999),h=(0,y.useMemo)(()=>je(r,"arc-avatar-overflow"),[r]),g=(0,y.useMemo)(()=>`${h}-anchor`,[h]),m=(0,y.useMemo)(()=>y.Children.toArray(a),[a]);return(0,i.jsxs)(i.Fragment,{children:[l>0&&(0,i.jsx)(vo,{count:l,anchorId:g,overflowId:h,shouldShowOverflow:n}),n&&l>0&&(0,i.jsx)(_a,{...v,"arc-avatar-overflow":"",id:h,anchorAt:c,boundary:s,alternateAnchor:g,hidePopoverButton:!0,variant:"common",isInverse:!0,"data-size":t,children:(0,i.jsx)(ho,{children:m.map((f,x)=>(0,i.jsx)(uo,{children:f},x))})})]})};_("ArcAvatarOverflow",po);const cr=u`arc•icon•text`,L=u`${cr}•icon`,E=u`${cr}•text`,zr=u`${cr}•subtext`,sr=u`${cr}•gap`,go=u`
...
`,fo=u`
  ...
  --${zr}-color: var(--arc-icon-text-subtext-color, color-mix(in srgb, currentcolor 61.2%, transparent));
  ...
  [arc-icon-text] {
    ...
    &[data-layout=gutter] {
      ...
      [data-element=subtext] {
        display: block;
        line-height: normal;
        font-size: var(--arc-icon-text-subtext-font-size, var(--${zr}-font-size));
        color: var(--arc-icon-text-subtext-color, var(--${zr}-color));
      }
...
`,$o=$(D,["inherit","primary","secondary","inverse","brand","info","success","warning","critical"]),Nr=({children:a,layout:r="gutter",size:t="inherit",variant:o="inherit",tag:n="span",icon:c,text:s,subtext:v,overflow:l,iconSize:h,gapSize:g,isFlipped:m=!1,isStrong:f=!1,...x})=>{const A=a||s,T=!!c,B=!!A,I=r==="gutter",C=r==="inline",k=T&&(!m||I),H=T&&B&&m&&C,J=!!h&&h!=="inherit",lr=J&&ha.includes(h)?h:void 0,W=J&&!ha.includes(h)?h:void 0,er=g!=="inherit"?g:void 0,_r=l!=="inherit"?l:void 0;return(0,i.jsxs)(n,{...x,"arc-icon-text":"","data-variant":o,"data-layout":r,"data-overflow":_r,"data-size":t,"data-gap":er,"icon-size":lr,"is-flipped":m?"":void 0,"is-strong":f?"":void 0,children:[k&&(0,i.jsx)(j,{"data-element":"icon",icon:c,size:W}),B&&(0,i.jsxs)("span",{"data-element":"text",children:[A,!!v&&(I?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("br",{}),(0,i.jsx)("small",{"data-element":"subtext",children:v})]}):(0,i.jsxs)(i.Fragment,{children:[" ",(0,i.jsx)("span",{"data-element":"subtext",children:v})]}))]}),H&&(0,i.jsx)(j,{"data-element":"icon",icon:c,size:W})]})};_("ArcIconText",xo);const yo=u`
@layer arc-components {
...
`,wo=$(G,["inherit","lg","md","sm"]),Ao=$(tr,["hug","fill"]),ko=["high","low"],zo=$(D,["brand-black","brand-blue","neutral","info","success","warning","critical","ai","overlay-light","overlay-dark"]),Co=({children:a,icon:r,text:t,isFlipped:o,isFlexible:n,isUppercase:c,variant:s="brand-blue",size:v="inherit",layout:l="hug",contrast:h="high",...g})=>{const m=a||(0,i.jsx)(Nr,{icon:r,text:t,isFlipped:o,layout:"gutter"}),f=l==="fill"&&n;return(0,i.jsx)("span",{...g,"arc-badge-wrapper":"",children:(0,i.jsx)("span",{"arc-badge":"","data-contrast":h,"data-variant":s,"data-layout":l,"data-size":v,"data-is-flexible":f?"":void 0,"data-is-uppercase":c?"":void 0,children:m})})};_("ArcBadge",yo);const So=u`
@layer arc-components {
...
`,_o=$(G,["inherit","lg","md","sm"]),jo=$(D,["neutral","brand","critical","warning","success","inverse"]),Eo=$(la,["square","circle"]),To=({children:a,text:r,variant:t="neutral",size:o="inherit",shape:n="square",...c})=>{const s=a||r;return(0,i.jsx)("span",{...c,"arc-badge-count-wrapper":"",children:(0,i.jsx)("span",{"arc-badge-count":"","data-variant":t,"data-shape":n,"data-size":o,children:s})})};_("ArcBadgeCount",So);const Io=u`
@layer arc-components {
...
`,Ro=$(tr,["hug","fill"]),br=({layout:a,...r})=>(0,i.jsx)("label",{...r,"arc-label":"","data-layout":a});_("ArcLabel",Io);const Po=u`
@layer arc-components {
...
`,fr=a=>(0,i.jsx)("span",{...a,"arc-label-content":""});_("LabelContent",Po);const Lo={checkbox:"checkbox",radio:"radio",switch:"radio"},Ur=({id:a,indeterminate:r,type:t,onChange:o,...n})=>{const c=t==="checkbox"&&!!r,s=(0,y.useRef)(null),v=(0,y.useMemo)(()=>a||ir(`arc-${t}`),[a]),l=h=>g=>{if(!(g?.target instanceof HTMLInputElement))return;const m={checked:g?.target.checked,indeterminate:g?.target?.indeterminate,name:g?.target?.name,value:n?.value};h?.(m,g)};return(0,y.useEffect)(()=>{s.current?.type==="checkbox"&&(s.current.indeterminate=!!r)},[r]),(0,i.jsx)("input",{...n,id:v,ref:s,type:Lo[t],"arc-input-type":t,"aria-disabled":n?.disabled||void 0,"data-is-disabled":n?.disabled||void 0,"data-is-checked":n?.checked||void 0,"data-is-indeterminate":c||void 0,onChange:l(o)})},Oo=u`
@layer arc-components {
...
`,oa=({type:a,...r})=>(0,i.jsx)("span",{"arc-input-mask-wrapper":"",children:(0,i.jsx)("span",{...r,"arc-input-mask":a})});_("ArcBooleanInputMask",Oo);const Mo=u`
@layer arc-components {
...
`,Bo=$(tr,["hug","fill"]),Ho=$(G,["inherit","md","sm"]),Vo=$(D,["primary","secondary"]),Oe=({children:a,label:r,layout:t,size:o="md",variant:n="primary",useMask:c=!0,...s})=>{const{className:v,title:l,...h}=s,g={className:v,title:l},m=a??r,f=(0,i.jsx)(Ur,{...h,type:"checkbox"}),x=c&&(0,i.jsxs)(oa,{type:"checkbox",children:[f,(0,i.jsx)(j,{icon:h?.indeterminate?"fa-solid fa-minus fa-fw":"fa-solid fa-check fa-fw"})]}),A=!!m&&(0,i.jsxs)(br,{layout:t,children:[x||f,(0,i.jsx)(fr,{children:m})]});return(0,i.jsx)("span",{...g,"arc-checkbox":"","data-size":o,"data-variant":n,children:A||x||f})};_("ArcCheckbox",Mo);const No=u`
@layer arc-components {
...
`,Uo=$(tr,["hug","fill"]),Fo=$(G,["lg","md"]),Do=({children:a,label:r,icon:t,...o})=>{const n=a||(0,i.jsx)(Nr,{icon:t,text:r});return(0,i.jsx)("li",{"arc-checkbox-bar-option":"","data-is-checked":o?.checked||void 0,children:(0,i.jsx)(Oe,{...o,label:n,layout:"fill",useMask:!1})})},Zo=({children:a,size:r="lg",layout:t="hug",...o})=>(0,i.jsx)("ul",{...o,"arc-checkbox-bar":"","data-size":r,"data-layout":t,role:"group",children:a});_("ArcCheckboxBar",No);const Yo=a=>(0,i.jsx)(Ar,{...a,layout:"icon",size:"md",variant:"common",hierarchy:"tertiary"}),X=u`arc•link`,N=u`${X}•icon`,U=u`${X}•text`,Xo=u`
@layer arc-components {
...
`,qo=$(D,["inherit","primary","secondary","inverse"]),Wo=({children:a,layout:r="gutter",size:t="inherit",variant:o="inherit",tag:n="a",href:c,icon:s,text:v,overflow:l,iconSize:h,gapSize:g,isFlipped:m,isDisabled:f,...x})=>(0,i.jsx)(n,{...x,href:f?void 0:c,"arc-link":"","data-variant":o,"aria-disabled":f,"data-is-disabled":f?"":void 0,children:a||(0,i.jsx)(Nr,{icon:s,text:v,overflow:l,iconSize:h,gapSize:g,size:t,layout:r,isFlipped:m})});_("ArcLink",Xo);const Go=u`
@layer arc-components {
...
`,Ko=$(tr,["hug","fill"]),Jo=$(G,["inherit","md","sm"]),Me=({children:a,label:r,layout:t,size:o="md",useMask:n=!0,...c})=>{const{className:s,title:v,...l}=c,h={className:s,title:v},g=a??r,m=(0,i.jsx)(Ur,{...l,type:"radio"}),f=n&&(0,i.jsxs)(oa,{type:"radio",children:[m,(0,i.jsx)(j,{icon:"fa-solid fa-circle-small fa-fw"})]}),x=!!g&&(0,i.jsxs)(br,{layout:t,children:[f||m,(0,i.jsx)(fr,{children:g})]});return(0,i.jsx)("span",{...h,"arc-radio":"","data-size":o,children:x||f||m})};_("ArcRadio",Go);const Qo=u`
@layer arc-components {
...
`,ri=$(tr,["hug","fill"]),ai=$(G,["lg","md"]),ei=({children:a,label:r,icon:t,...o})=>{const n=a||(0,i.jsx)(Nr,{icon:t,text:r});return(0,i.jsx)("li",{"arc-radio-bar-option":"","data-is-checked":o?.checked||void 0,children:(0,i.jsx)(Me,{...o,label:n,layout:"fill",useMask:!1})})},ti=({children:a,size:r="lg",layout:t="hug",...o})=>(0,i.jsx)("ul",{...o,"arc-radio-bar":"","data-size":r,"data-layout":t,role:"radiogroup",children:a});_("ArcRadioBar",Qo);const oi=$(G,["inherit","md","sm"]),M={On:"on",Off:"off"},Cr={Before:"before",After:"after"},ii=({disabled:a,id:r,name:t,size:o="md",value:n,labelOff:c,labelOn:s,onChange:v,...l})=>{const h=(0,y.useMemo)(()=>t||ir("arc-switch-name"),[t]),g=(0,y.useMemo)(()=>r&&`${r}-off`||ir("arc-switch-off"),[r]),m=(0,y.useMemo)(()=>r&&`${r}-on`||ir("arc-switch-on"),[r]),f=C=>{if(C.code==="Space"){C.preventDefault(),C.stopPropagation();const k=n===M.On?M.Off:M.On;v?.({value:k},C)}},x=C=>{const k={on:Br(s),off:Br(c)};return k?.on&&k?.off?k[C]:!k?.on&&k?.off?`${k?.off}: ${C}`:k?.on&&!k?.off?`${k?.on}: ${C}`:k[C]},A=(0,i.jsxs)(oa,{type:"switch",onKeyDown:f,children:[(0,i.jsx)(Ur,{type:"switch",name:h,id:g,value:M.Off,checked:n===M.Off,disabled:a,"aria-label":x(M.Off)?.trim(),onChange:v}),(0,i.jsx)(Ur,{type:"switch",name:h,id:m,value:M.On,checked:n===M.On,disabled:a,"aria-label":x(M.On)?.trim(),onChange:v}),(0,i.jsx)("span",{"data-element":"mask"})]}),T=!s&&n===M.Off?m:g,B=!c&&n===M.On?g:m,I=!!(s||c)&&(0,i.jsxs)(i.Fragment,{children:[!!c&&(0,i.jsx)(br,{htmlFor:T,"arc-switch-label":s?M.Off:"",children:(0,i.jsx)(fr,{children:c})}),A,!!s&&(0,i.jsx)(br,{htmlFor:B,"arc-switch-label":c?M.On:"",children:(0,i.jsx)(fr,{children:s})})]});return(0,i.jsx)("span",{...l,"arc-switch":"","data-state":n,"data-size":o,role:"radiogroup",children:I||A})},ni=u`
@layer arc-components {
...
`,ci=({disabled:a,id:r,name:t,size:o="md",value:n,label:c,labelPosition:s=Cr.After,onChange:v,labelOff:l,labelOn:h,...g})=>{const m=(0,y.useMemo)(()=>t||ir("arc-switch-name"),[t]),f=(0,y.useMemo)(()=>r||ir("arc-switch"),[r]),x=(B,I)=>{const C=B.checked?M.On:M.Off;v?.({...B,value:C},I)};!c&&(h||l)&&(c=h||l,s=h?Cr.After:Cr.Before);const A=(0,i.jsxs)(oa,{type:"checkbox",children:[(0,i.jsx)(Ur,{type:"checkbox",name:m,id:f,checked:n===M.On,disabled:a,role:"switch","aria-checked":n===M.On,"aria-label":c?void 0:"Toggle switch",tabIndex:0,onChange:x}),(0,i.jsx)("span",{"data-element":"mask","aria-hidden":"true",tabIndex:-1})]}),T=(0,i.jsx)(br,{htmlFor:f,"arc-switch-label":s,children:(0,i.jsx)(fr,{children:c})});return l&&h?(0,i.jsx)(ii,{...g,disabled:a,id:r,name:t,labelOff:l,labelOn:h,size:o,value:n,onChange:v}):(0,i.jsxs)("span",{...g,"arc-switch":"","data-state":n,"data-size":o,"data-label-position":s,role:"presentation","aria-live":"off",children:[c&&s===Cr.Before&&T,A,c&&s===Cr.After&&T]})};_("ArcSwitch",ni);const si=["title","heading","subheading","body"],Be=["h1","h2","h3","h4","h5","h6"],He=["code","div","li","p","pre","span"],Ve=[...Be,...He],li=["title-inherit","title-lg","title-md","title-sm"],di=["heading-inherit","heading-lg","heading-md","heading-sm"],pi=["subheading-inherit","subheading-lg","subheading-md","subheading-sm"],hi=$(D,["inherit","primary","primary-inverse"]),ui=["body-inherit","body-lg","body-md","body-sm","body-xs"],vi=$(D,["inherit","primary","secondary","primary-inverse","secondary-inverse","critical","warning","success","info"]),mi=$(La,["inherit","start","center","justify","end"]),gi=$(Oa,["inherit","loose","standard","tight"]),bi={h1:"title",h2:"heading",h3:"heading",h4:"subheading",h5:"subheading",h6:"subheading",p:"body",span:"body",div:"body",code:"body",pre:"body",li:"body"},fi=a=>{const{align:r,lineHeight:t,size:o,variant:n,isMonospace:c,tag:s,...v}=a,l=bi?.[s]??"body",h=o?.includes("inherit")?o?.split("-")?.[0]:o;return{...v,"arc-text":h||l,"data-is-monospace":c?"":void 0,"data-align":r?.includes("inherit")?void 0:r,"data-variant":n?.includes("inherit")?void 0:n,"data-line-height":t?.includes("inherit")?void 0:t}},xi=u`
@layer arc-components {
...
`,$i=a=>(0,y.forwardRef)((r,t)=>(0,y.createElement)(a,{...fi({...r,tag:a}),ref:t})),yi=[...Ve].reduce((a,r)=>({...a,[r]:$i(r)}),{});_("Arc",xi);const Sr=a=>(0,i.jsx)(i.Fragment,{children:!!a.children&&(0,i.jsx)("span",{...a})}),wi=a=>(0,i.jsx)(i.Fragment,{children:!!a.children&&(0,i.jsx)("span",{...a})}),ja=({children:a,...r})=>(0,i.jsx)(i.Fragment,{children:!!a&&(0,i.jsx)(br,{...r,children:(0,i.jsx)(fr,{children:a})})}),Ai=({children:a,layout:r,size:t,variant:o,tag:n="span",...c})=>(0,i.jsx)(n,{...c,"data-layout":r,"data-size":t,"data-variant":o,children:a}),ki=()=>(0,i.jsx)("span",{"input-element":"spacer"}),zi=a=>(0,i.jsx)(Sr,{...a,"input-element":"header"}),Ci=a=>(0,i.jsx)(ja,{...a,"input-element":"header-label"}),Si=a=>(0,i.jsx)(Sr,{...a,"input-element":"header-slot"}),_i=a=>(0,i.jsx)(Sr,{...a,"input-element":"body"}),ji=a=>(0,i.jsx)(ja,{...a,"input-element":"input-prefix"}),Ei=a=>(0,i.jsx)(ja,{...a,"input-element":"input-suffix"}),Ti=a=>(0,i.jsx)(wi,{...a,"input-element":"input-action"}),Ii=a=>(0,i.jsx)(Sr,{...a,"input-element":"footer"}),Ri=a=>(0,i.jsx)(Sr,{...a,"input-element":"footer-caption"}),Pi=a=>(0,i.jsx)(Sr,{...a,"input-element":"footer-slot"}),Li=a=>r=>{if(!(r?.target instanceof HTMLInputElement))return;const t={name:r?.target?.name,value:r?.target?.value};a?.(t,r)},Oi=u`
@layer arc-components {
...
`,Mi={onChangeHandler:Li,Wrapper:Ai,Spacer:ki,Header:zi,HeaderLabel:Ci,HeaderSlot:Si,InputBody:_i,InputPrefix:ji,InputSuffix:Ei,InputAction:Ti,Footer:Ii,FooterCaption:Ri,FooterSlot:Pi};_("ArcInput",Oi);const q=Mi,Bi=$(tr,["fill","hug"]),Hi=$(G,["inherit","xl","lg","md"]),Vi=$(D,["outline","solid"]),Ni=Bi,Ui=Hi,Fi=Vi,Di=["text","number","password","email","url"],Zi=(0,y.forwardRef)(({layout:a="hug",size:r="inherit",variant:t="outline",inputProps:o,headerLabel:n,headerSlot:c,inputPrefix:s,inputAction:v,inputSuffix:l,footerCaption:h,footerSlot:g,...m},f)=>{const{id:x,onChange:A,...T}=o,B=T?.type||"text",I=T?.disabled||void 0,C=T?.readOnly||void 0,k=T?.required||void 0,H=!!(n||c),J=!!(h||g);return(0,i.jsxs)(q.Wrapper,{...m,"arc-text-input":"","arc-input":B,layout:a,size:r,variant:t,children:[H&&(0,i.jsxs)(q.Header,{children:[(0,i.jsx)(q.HeaderLabel,{htmlFor:x,children:n}),!!c&&(0,i.jsx)(q.Spacer,{}),(0,i.jsx)(q.HeaderSlot,{children:c})]}),(0,i.jsxs)(q.InputBody,{children:[(0,i.jsx)(q.InputPrefix,{htmlFor:x,children:s}),(0,i.jsx)("input",{...T,ref:f,id:x,"arc-input-type":B,onChange:q.onChangeHandler(A),"aria-disabled":I,"aria-readonly":C,"aria-required":k}),(0,i.jsx)(q.InputSuffix,{htmlFor:x,children:l}),(0,i.jsx)(q.InputAction,{children:v})]}),J&&(0,i.jsxs)(q.Footer,{children:[(0,i.jsx)(q.FooterCaption,{children:h}),!!g&&(0,i.jsx)(q.Spacer,{}),(0,i.jsx)(q.FooterSlot,{children:g})]})]})}),Ne=u`arc•progress`,Ue=u`${Ne}•bar`,Fr=u`${Ne}•value`,Yi=u`
@layer arc-components {
[arc-progress-bar] {
  --${Ue}-background: var(--arc-color-alpha-white-20);
  --${Fr}-background: var(--arc-color-brand-root);

  &[data-variant=ai] {
    --${Fr}-background: linear-gradient(to right, var(--arc-color-ai-purple-200), var(--arc-color-ai-blue-200));
  }

  &[data-variant=critical] {
    --${Fr}-background: var(--arc-color-critical-root);
  }
}
...
[arc-progress-bar] {
  ...
  background: var(--arc-progress-bar-background, var(--${Ue}-background));
  ...
  &::-moz-progress-bar {
    border-radius: var(--arc-border-radius-pill);
    background: var(--arc-progress-bar-value-background, var(--${Fr}-background));
  }
...
`,Xi=({progress:a=0,variant:r="common",...t})=>(0,i.jsxs)("progress",{...t,"arc-progress-bar":"","data-variant":r,value:a,max:t.max||100,"aria-valuenow":a,"aria-valuemax":t.max||100,children:[a,"% "]});_("ArcProgressBar",Yi);const qi=u`
@layer arc-components {
...
`,Wi=$(D,["common","ai","critical"]),Gi=["default","success","warning","error"],Ki=$(G,["inherit","md"]),Ji=$(D,["common"]),Qi=$(da,["","auto","manual"]),rn=["top-left","top-center","top-right","center","bottom-left","bottom-center","bottom-right"],an=Wi.filter(a=>a!=="critical"),en=(a,r="toggle")=>{const t=document.getElementById(a);({toggle:()=>t?.togglePopover(),show:()=>t?.showPopover(),hide:()=>t?.hidePopover()})[r]()},Fe=({id:a,children:r,icon:t,heading:o,subtext:n,dismissProps:c,showDismiss:s=!0,onClose:v,actionSlot:l,size:h="md",variant:g="common",placement:m="bottom-left",getToastId:f,progressBarProps:x,severity:A,...T})=>{const B=()=>{v?.()},I=!!l||s,C=(0,y.useMemo)(()=>a||ir("arc-toast"),[a]),{variant:k,hierarchy:H,...J}=c||{};return(0,y.useEffect)(()=>{f?.(C)},[f,C]),(0,i.jsx)("div",{...T,"arc-toast":"","data-size":h,"data-variant":g,"data-placement":m,"data-severity":A||void 0,id:C,children:(0,i.jsxs)("div",{"arc-toast-content-grid":"",children:[(0,i.jsxs)("div",{"arc-toast-body":"",children:[t&&(0,i.jsx)(j,{icon:t,"arc-toast-icon":""}),(0,i.jsx)("div",{"arc-toast-content":"",children:r||(0,i.jsxs)(i.Fragment,{children:[o&&(0,i.jsx)("header",{"arc-toast-heading":"",children:(0,i.jsx)("strong",{children:o})}),n&&(0,i.jsx)("p",{"arc-toast-subtext":"",children:n})]})})]}),I&&(0,i.jsxs)("div",{"arc-toast-actions":"",children:[l,s&&(0,i.jsx)(Ar,{icon:"fa-regular fa-xmark-large",layout:"icon",variant:"common",hierarchy:"tertiary",isInverse:!0,size:"md",shape:"square","aria-label":"Dismiss",...J,popovertarget:C,onClick:B})]}),x&&(0,i.jsx)(Xi,{...x,variant:A==="error"?"critical":x.variant,"arc-toast-progress-bar":""})]})})};Fe.handleToast=en,_("ArcToast",qi);const tn=(a,r=1/0,t=" ")=>[...a].flat(r)?.filter(Boolean)?.join(t)}}]);
